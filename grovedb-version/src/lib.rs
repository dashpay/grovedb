...
/// Dispatches a cost-returning method body by feature version. Unknown
/// versions return `UnknownVersionMismatch` wrapped in a `CostResult`, so
/// this belongs in functions returning `CostResult<_, _>`.
#[macro_export]
