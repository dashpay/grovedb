    ...
    pub(crate) fn clear_subtree_with_costs_v1<'b, B: AsRef<[u8]>>(
            ...
            .is_empty()
        {
            return Err(Error::NotSupported(
                "clear_subtree cannot remove backward-reference participants; delete them normally first or declare BackwardsReferences::DontCheck for a raw clear".to_owned(),
            )).wrap_with_cost(cost);
        }
                        ...
                        cost_return_on_error!(
                            ...
                            self.delete(
                                ...
                                Some(DeleteOptions {
                                    ...
                                    backwards_references: options.backwards_references,
                                    ..Default::default()
                                }),
                                Some(tx.as_ref()),
                                grove_version,
