...
mod tests {
    ...
    fn test_one_insert_item_cost() {
        ...
        assert_eq!(
            cost,
            OperationCost {
                seek_count: 4, /* 1 to get tree, 1 to get the previous value, 1 to insert, 1 to
    ...
    fn test_one_insert_item_cost_with_flags() {
        ...
        assert_eq!(
            cost,
            OperationCost {
                seek_count: 4, /* 1 to get tree, 1 to get previous data, 1 to insert, 1 to insert
                                * into root tree */
                storage_cost: StorageCost {
                    added_bytes: 153,
                    replaced_bytes: 0,
    ...
    fn test_one_update_same_cost_in_underlying_sum_tree_bigger_sum_item() {
        ...
        assert_eq!(
            ...
            OperationCost {
                ...
                storage_loaded_bytes: 427, // todo verify this
                hash_node_calls: 9,
            }
        );
    }
    ...
    fn test_one_update_same_cost_in_underlying_sum_tree_bigger_sum_item_parent_sum_tree_already_big(
        ...
        assert_eq!(
            ...
            OperationCost {
                ...
                storage_loaded_bytes: 648, // todo verify this
                hash_node_calls: 11,
            }
        );
    }
    ...
    fn test_one_update_same_cost_in_underlying_sum_tree_smaller_sum_item() {
        ...
        assert_eq!(
            ...
            OperationCost {
                ...
                storage_loaded_bytes: 437, // todo verify this
                hash_node_calls: 9,
            }
        );
    }
