...
fn test_path_query_proofs_without_subquery() {
    ...
    assert_eq!(
        ...
        "02000000000000007504046b6579310009000676616c7\
        56531009e085c4f307cba0294cfa85d75ac295788492d6\
        b2f3392e6726eab214045a8a302018655e18e4555b0b65\
        bbcec64c749db6b9ad84231969fb4fbe769a3093d10f21\
        00198ebd6dc7e1c82951c41fcfa6487711cac6a399ebb0\
        1bb979cbe4a51e0b2f08d1101000000000000004f04096\
        96e6e657274726565002202dae55c8bc9d330808358526\
        ceecd881e8e205d19e50c78cdd2f355ada0246b6400fdc\
        0c6db3ba392fdb54a6bcecd1cd85104f347c1ce5e541ce\
        e76ed7c19b572140100000000000000710409746573745\
        f6c656166002202c52ba7ba97bb0cf1862352aa2737630\
        12f46e77f86b690f184a8d89e44bd65be00dc0bac8829f\
        d4f4250c01813375c0650ce8083c9f9b0ec27f67df46fc\
        c0c579f01b54a449bcb1ad8bb0da34a3a3c1b8a34c89bd\
        426a9d4fe059e1ad88e53bf875011"
    );
    let (hash, result_set) =
        GroveDb::verify_query(proof.as_slice(), &path_query).expect("should execute proof");
