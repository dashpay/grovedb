...
pub enum Element {
    ...
    /// `ProvableCountSumTree`, `ProvableCountProvableSumTree`) — the only
    /// tree types where suppressing both axes is meaningful. Any other
    /// parent rejects the wrapper at insert.
    ///
