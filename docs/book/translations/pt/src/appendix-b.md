# Apendice B: Referencia Rapida do Sistema de Provas

## Provas V0 (Apenas Merk)
...
## Provas V1 (Mistas Merk + Nao-Merk)

Quando qualquer camada envolve uma CommitmentTree, MmrTree, BulkAppendTree ou
DenseAppendOnlyFixedSizeTree, uma prova V1 e gerada:
...
**Selecao V0/V1**: Se todas as camadas sao Merk, produz V0 (retrocompativel).
Se qualquer camada for uma arvore nao-Merk, produz V1.
