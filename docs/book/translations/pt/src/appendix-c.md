# Apendice C: Referencia de Computacao de Hash
...
## Prefixo de Subarvore do GroveDB
...
O buffer e uma DenseFixedSizedMerkleTree — `dense_tree_root` e seu hash raiz.

## Raiz Densa de Merkle — Chunks da BulkAppendTree
...
## Hash Raiz da Arvore Densa — DenseAppendOnlyFixedSizeTree
...
## Verificacao de Prova da Arvore Densa — DenseAppendOnlyFixedSizeTree
...
## Merge de Nos MMR — MmrTree / Chunk MMR da BulkAppendTree
...
## combine_hash (Vinculacao Pai-Filho)
...
*O Livro GroveDB — documentando os internos do GroveDB para desenvolvedores e
pesquisadores. Baseado no codigo-fonte do GroveDB.*
