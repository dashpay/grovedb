# Ek B: Ispat Sistemi Hizli Referansi

## V0 Ispatlar (Yalnizca Merk)
...
## V1 Ispatlar (Karisik Merk + Merk-disi)

Herhangi bir katman CommitmentTree, MmrTree, BulkAppendTree veya DenseAppendOnlyFixedSizeTree icerdiginde, bir V1 ispati olusturulur:
...
**V0/V1 secimi**: Tum katmanlar Merk ise V0 uretilir (geriye uyumlu). Herhangi bir katman Merk-disi agac ise V1 uretilir.
