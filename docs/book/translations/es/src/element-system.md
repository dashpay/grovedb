...
- Los datos reales de las notas (`cmx || rho || cv_net || ciphertext`) se almacenan a través de un **BulkAppendTree**
...
**Operaciones:**
- `commitment_tree_insert(path, key, cmx, rho, cv_net, ciphertext, tx)` — Inserción tipada
