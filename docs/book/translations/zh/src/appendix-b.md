...
## V1 证明（混合 Merk + 非 Merk）

当任何层涉及 CommitmentTree、MmrTree、BulkAppendTree 或 DenseAppendOnlyFixedSizeTree 时，生成 V1 证明：
...
**V0/V1 选择**：如果所有层都是 Merk，生成 V0（向后兼容）。如果任何层是非 Merk 树，则生成 V1。
