...
|----------|------|-----------|---------------------|
| **Шор** | Дискретный логарифм ECC, факторизация RSA | Экспоненциальное (полиномиальное время) | **Полный взлом** ECC |
...
| Инфраструктура GroveDB Merk/MMR/Blake3 | **Уже квантово-безопасна.** Действий не требуется, ни сейчас, ни когда-либо. |
...
│                                                                     │
│  БЕЗОПАСНО СЕЙЧАС И НАВСЕГДА (на основе хешей):                     │
