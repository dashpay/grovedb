# Appendice B: Riferimento rapido del sistema di prove
...
## Prove V1 (Merk + non-Merk miste)

Quando un qualsiasi livello coinvolge un CommitmentTree, MmrTree, BulkAppendTree o DenseAppendOnlyFixedSizeTree, viene generata una prova V1:
...
**Selezione V0/V1**: Se tutti i livelli sono Merk, produce V0 (retrocompatibile). Se un qualsiasi livello e un albero non-Merk, produce V1.
