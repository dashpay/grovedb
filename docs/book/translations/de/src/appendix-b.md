# Anhang B: Kurzreferenz des Beweissystems
...
## V1-Beweise (Gemischt Merk + Nicht-Merk)

Wenn eine Schicht einen CommitmentTree, MmrTree, BulkAppendTree oder
DenseAppendOnlyFixedSizeTree enthält, wird ein V1-Beweis erzeugt:
...
**V0/V1-Auswahl**: Wenn alle Schichten Merk sind, wird V0 erzeugt (abwärtskompatibel).
Wenn eine Schicht ein Nicht-Merk-Baum ist, wird V1 erzeugt.
