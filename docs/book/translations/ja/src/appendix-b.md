...
## V1 証明（Merk + 非 Merk 混合）

いずれかのレイヤーが CommitmentTree、MmrTree、BulkAppendTree、または DenseAppendOnlyFixedSizeTree を含む場合、V1 証明が生成されます：
...
**V0/V1 の選択**：すべてのレイヤーが Merk の場合は V0 を生成（後方互換）。いずれかのレイヤーが非 Merk ツリーの場合は V1 を生成。
