...
### Disposition de l'enregistrement stocke (312 octets pour DashMemo)
...
| Enregistrement complet stocke (cmx+rho+cv_net+payload) | **312 octets** | **788 octets** | Entree BulkAppendTree |
