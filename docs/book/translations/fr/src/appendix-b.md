# Annexe B : Reference rapide du systeme de preuves

## Preuves V0 (Merk uniquement)
...
## Preuves V1 (mixte Merk + non-Merk)

Quand une couche implique un CommitmentTree, MmrTree, BulkAppendTree, ou
DenseAppendOnlyFixedSizeTree, une preuve V1 est generee :
...
**Selection V0/V1** : Si toutes les couches sont Merk, produire V0 (retrocompatible).
Si une couche est un arbre non-Merk, produire V1.
