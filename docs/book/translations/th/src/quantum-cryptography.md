...
|-----------|---------|---------------------|---------------------|
| **Shor** | ECC discrete log, RSA factoring | แบบเลขชี้กำลัง (เวลาพหุนาม) | **ทำลายได้ทั้งหมด** ของ ECC |
...
### โครงสร้างพื้นฐาน GroveDB: ปลอดภัยจากควอนตัมอย่างสมบูรณ์
...
**ไม่จำเป็นต้องเปลี่ยนแปลง** หลักฐาน Merk tree ของ GroveDB, การตรวจสอบ
ความสอดคล้อง MMR, root epoch ของ BulkAppendTree และห่วงโซ่การยืนยันตัวตน
หลักฐาน V1 ทั้งหมดยังคงปลอดภัยจากคอมพิวเตอร์ควอนตัม โครงสร้างพื้นฐานที่อิง
แฮชเป็นส่วนที่แข็งแกร่งที่สุดของระบบหลังยุคควอนตัม
...
| โครงสร้างพื้นฐาน GroveDB Merk/MMR/Blake3 | **ปลอดภัยจากควอนตัมแล้ว** ไม่จำเป็นต้องดำเนินการ ตอนนี้หรือในอนาคต |
