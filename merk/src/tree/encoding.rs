...
impl Tree {
        ...
        Error: From<S::Error>,
    {
        ...
        dbg!("Tree bytes are", tree_bytes.clone());

        dbg!("Decoding the tree bytes");
        let tree_opt = cost_return_on_error_no_add!(
            &cost,
            tree_bytes.map(|x| Tree::decode_raw(&x)).transpose()
        );
        dbg!("Done decoding the tree bytes", tree_opt.clone());
...
mod tests {
    ...
    fn encode_loaded_tree() {
        ...
        assert_eq!(
            ...
            vec![
                ...
                66, 66, 66, 66, 66, 66, 66, 66, 66, 66, 66, 66, 66, 66, 123, 124, 0, 0, 55, 55, 55,
    ...
    fn decode_leaf_tree() {
        let bytes = vec![
            0, 0, 0, 55, 55, 55, 55, 55, 55, 55, 55, 55, 55, 55, 55, 55, 55, 55, 55, 55, 55, 55, 55,
    ...
    fn decode_reference_tree() {
        let bytes = vec![
            ...
            66, 66, 66, 66, 66, 66, 66, 66, 66, 66, 66, 66, 66, 123, 124, 0, 0, 55, 55, 55, 55, 55,
